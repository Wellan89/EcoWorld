...
// Pris de Irrlicht SVN 1.8.0-alpha (Cette version a été légèrement modifiée : utilisation du timer d'Irrlicht (passé en argument), pour pallier à l'absencee de la fonction os::getTime())
