...
// - Correction de bugs de par l'implémentation des fonctions setPosition() et setScale()
// - Plusieurs optimisations, dont une optimisation importante par le remplacement de tableaux (core::array) par des listes (core::list) diminuant la consommation mémoire et fournissant un code plus rapide
// - Le billboard material a été supprimé pour utiliser le matériau général de l'arbre à la place, mais adapté au billboard
...
public:	// Fonctions adaptées inline
